...
if (!i18next.isInitialized) // prevent i18next to be initialized multiple times
  i18next
    ...
    .init(i18nextOptions)
    .then(() => {
      i18next.services.backendConnector.backend = { read: (language, namespace, callback) => callback(null, {}) } // has custom backend, but simulate this to check for ready flag in useTranslation
